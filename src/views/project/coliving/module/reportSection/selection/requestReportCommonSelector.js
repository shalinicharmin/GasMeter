...
const RequestReportCommonSelector = props => {
  ...
  return (
    <Row className='mb-2'>
      ...
      <Col lg='2' xs='6'>
        <Button color='primary' className='btn-block  px_5' onClick={onReportRequestButtonClicked}>
          Request Report
        </Button>
      </Col>
      <Col lg='2' xs='6'>
        <Button color='primary' className='btn-block px_5' onClick={onSearchButtonClicked}>
          Search Report
        </Button>
      </Col>
    </Row>
