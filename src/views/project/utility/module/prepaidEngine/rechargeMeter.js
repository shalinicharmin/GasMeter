...
const RechargeMeter = (props) => {
  ...
  useEffect(async () => {
    if (rechargeMeter) {
      ...
      if (statusCode === 200) {
        ...
        const [statusCode_1, response_1] = await executeOfflineRechargeCommand(
          request_body_1
        );
        ...
        if (statusCode_1 === 201) {
          ...
          const [statusCode_2, response_2] =
            await executeOfflineRechargeCommand(request_body_2);
          ...
          if (statusCode_2 === 201) {
            ...
            const [statusCode_3, response_3] =
              await executeOfflineRechargeCommand(request_body_3);
            ...
            if (statusCode_3 === 201) {
              if (
                ...
                toast.success(
                  <Toast msg="Meter successfully recharged" type="success" />,
  ...
  const handleButtonClick = () => {
    ...
    if (isInt(rechargeValue)) {
      ...
      toast.error(<Toast msg="Enter Integer value ." type="danger" />, {
        hideProgressBar: true,
      });
    }
  };
