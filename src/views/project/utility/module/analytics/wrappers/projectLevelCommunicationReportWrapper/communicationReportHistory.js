...
const CommunicationReportHistory = props => {
  ...
  const [filterParams, setFilterParams] = useState({ reportId: default_report_type.value, intervalDays: default_report_type.numberOfDays })
  const [ReportRequestFilterParams, setReportRequestFilterParams] = useState({
    reportId: default_report_type.value,
    intervalDays: default_report_type.numberOfDays
  })
    ...
    <div>
      ...
      {!retry && (
        <SimpleDataTable
          ...
          tblData={response}
          rowCount={10}
          tableName={'Communication Report Request History'}
          refresh={refresh}
...
export default CommunicationReportHistory
