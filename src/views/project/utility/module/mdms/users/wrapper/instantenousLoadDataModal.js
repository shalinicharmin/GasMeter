...
const InstantenousLoadDataModal = (props) => {
  ...
  const fetchData = async (params) => {
    return await useJwt
      // .getMDMSMeterProfileInstantData(params)
      .getMDMSGroupMeterProfileInstantData(params)
      .then((res) => {
        ...
        {fetchingData ? (
          ...
          <div>
            <Row className='mb-2'>
              ...
              <Col lg='2' xs='4'>
                <Button color='primary' className='btn-block mt-2' onClick={onSubmitButtonClicked}>
                  Submit
                </Button>
              </Col>
            </Row>
...
export default InstantenousLoadDataModal
