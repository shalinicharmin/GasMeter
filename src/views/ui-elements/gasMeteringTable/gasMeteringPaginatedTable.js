  ...
  if (!props.tblData && props.tblData.length <= 0) {
    ...
    return (
      <Fragment>
        <Card
          className={
            props.height ? "max-height-600 px-1 webi_scroller" : "min-height-475 px-1 webi_scroller"
          }
        >
          ...
          <DataTable
            ...
            pointerOnHover={props.hidePointerOnHover ? !props.hidePointerOnHover : true}
...
export default GasMeteringPaginatedTable
