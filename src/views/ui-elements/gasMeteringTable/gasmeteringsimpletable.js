...
import {
  ...
  DownloadExcel,
  DownloadPDF,
} from '@src/views/ui-elements/dataTableUpdated/wrapper/downloadTableData.js';

const GasMeteringSimpleTable = (props) => {
              ...
              <Fragment>
                {props.status ? (
                  <Spinner
                    ...
                    id="refresh_table"
                    size="sm"
                    className="ml-1 cursor-pointer float-right mt_9"
                  />
                ) : (
                  <RefreshCw
                    onClick={() => props.refresh()}
...
export default GasMeteringSimpleTable;
